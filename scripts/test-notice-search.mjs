...
for (const field of ["purchaseContent", "budget", "saleTime", "deadline", "qualification", "performance", "deadlineStatus", "deadlineEvidence", "deadlineSource", "extractorVersion"]) {
  assert(Object.hasOwn(allZhejiang.items[0], field), `search item missing ${field}`);
}
